...
public class ClassReview {
	...
	public String toString() {
		return "ClassReview [reviewNo=" + reviewNo + ", reviewStar=" + reviewStar + ", reviewContent=" + reviewContent
				+ ", reviewDt=" + reviewDt + ", reviewStatus=" + reviewStatus + ", regNo=" + regNo + ", reviewAvg="
				+ reviewAvg + ", className=" + className + ", epCount=" + epCount + ", memberName=" + memberName
				+ ", memberNo=" + memberNo + ", memberImg=" + memberImg + "]";
	}
