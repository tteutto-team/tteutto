...
<link rel="stylesheet" type="text/css" href="${contextPath}/resources/css/admin/classUpdate.css">
...
<div id="right">
	<div>
		...
		---------------------------------------------------------------------------- <br>
		수정후 <br>
		지역 : ${classOne2.classArea} <br>
		수업 최소 인원 : ${classOne2.classMinPerson} <br>
		수업 최대 인원 : ${classOne2.classMaxPerson} <br>
		클래스 이름 : ${classOne2.className} <br>
		수업 소개 : ${classOne2.classIntro} <br>
